...
Mac demonstrated the device to an old friend and WIN agent, Sam Loover. After Loover reported the demonstration to Section Chief Shane Weston, the project was classified as top secret. WIN fully adopted the system and enlisted young Joe, who could utilize the technology via a special pair of glasses for mobile operation. Set in a world where the Cold War had ended, the stories address various international disputes and security concerns; the narrative plays on the conventional wisdom—or the common refrain told to children—that "a child couldn't possibly do such a thing," allowing Joe to carry out espionage missions for WIN and embark on dangerous, adventurous assignments.
