...
Captain Scarlet and the Mysterons1967 is the siries of 32 episodes in 1968.
The series features a variety of vehicles, including the Angel Interceptors launched from the airborne "Cloud Base," liaison aircraft, and the powerful Spectrum Pursuit Vehicle (SPV) used for ground-based attacks against the Mysterons. On the other hand, since the Mysterons are energy-based lifeforms, they do not employ their own machinery; in other words, Spectrum's technology becomes the Mysterons' weaponry.
...
Mac perfected a groundbreaking device known as BIG RAT (Brain Impulse Galvanoscope Record and Transfer). It was an expert system capable of copying knowledge and experience from experts via an antenna and uploading that data into another person—using a rotating mechanism called the "Rat Trap"—thereby allowing the recipient to utilize that expertise.

Mac demonstrated the device to an old friend and WIN agent, Sam Loover. After Loover reported the demonstration to Section Commander-in-chief Shane Weston, the project was classified as top secret. WIN fully adopted the system and enlisted young Joe, who could utilize the technology via a special pair of glasses for mobile operation. Set in a world where the Cold War had ended, the stories address various international disputes and security concerns; the narrative plays on the conventional wisdom—or the common refrain told to children—that "a child couldn't possibly do such a thing," allowing Joe to carry out espionage missions for WIN and embark on dangerous, adventurous assignments.

While some might point out potential compliance issues by modern standards, the series can be seen as the embodiment of a child's dream to play "Bond." Its creation was influenced by the social context of the time—specifically the popularity of the *007* film series in the UK and the massive appeal among children of the gadget-laden Aston Martin DB5 "Bond car."
